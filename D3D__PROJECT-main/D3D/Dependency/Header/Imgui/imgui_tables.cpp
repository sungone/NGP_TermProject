...
void ImGui::TableSetBgColor(ImGuiTableBgTarget target, ImU32 _color, int column_n)
{
    ImGuiContext& g = *GImGui;
    ImGuiTable* table = g.CurrentTable;
    IM_ASSERT(target != ImGuiTableBgTarget_None);

    if (_color == IM_COL32_DISABLE)
        _color = 0;
    ...
    case ImGuiTableBgTarget_RowBg1:
    {
        ...
        table->RowBgColor[bg_idx] = _color;
        break;
    }
    default:
        IM_ASSERT(0);
