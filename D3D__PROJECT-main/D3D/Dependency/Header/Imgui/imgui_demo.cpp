...
static void ShowDemoWindowWidgets()
{
    ...
    {
        static ImVec4 _color = ImVec4(114.0f / 255.0f, 144.0f / 255.0f, 154.0f / 255.0f, 200.0f / 255.0f);
        ...
        ImGui::SameLine(); HelpMarker(
            "Click on the color square to open a color picker.\n"
            "CTRL+click on individual component to input value.\n");
        ImGui::ColorEdit3("MyColor##1", (float*)&_color, misc_flags);

        IMGUI_DEMO_MARKER("Widgets/Color/ColorEdit (HSV, with Alpha)");
        ImGui::Text("Color widget HSV with Alpha:");
        ImGui::ColorEdit4("MyColor##2", (float*)&_color, ImGuiColorEditFlags_DisplayHSV | misc_flags);

        IMGUI_DEMO_MARKER("Widgets/Color/ColorEdit (float display)");
        ImGui::Text("Color widget with Float Display:");
        ImGui::ColorEdit4("MyColor##2f", (float*)&_color, ImGuiColorEditFlags_Float | misc_flags);
        ...
        ImGui::ColorEdit4("MyColor##3", (float*)&_color, ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel | misc_flags);
        ...
        bool open_popup = ImGui::ColorButton("MyColor##3b", _color, misc_flags);
        ...
        if (ImGui::BeginPopup("mypicker"))
        {
            ...
            ImGui::Separator();
            ImGui::ColorPicker4("##picker", (float*)&_color, misc_flags | ImGuiColorEditFlags_NoSidePreview | ImGuiColorEditFlags_NoSmallPreview);
            ImGui::SameLine();
        ...
        ImGui::ColorButton("MyColor##3c", *(ImVec4*)&_color, misc_flags | (no_border ? ImGuiColorEditFlags_NoBorder : 0), ImVec2(80, 80));
        ...
        ImGui::ColorPicker4("MyColor##4", (float*)&_color, flags, ref_color ? &ref_color_v.x : NULL);
        ...
        ImGui::ColorPicker3("##MyColor##5", (float*)&_color, ImGuiColorEditFlags_PickerHueBar | ImGuiColorEditFlags_NoSidePreview | ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoAlpha);
        ImGui::SameLine();
        ImGui::SetNextItemWidth(w);
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Modals"))
    {
        ...
        if (ImGui::BeginPopupModal("Stacked 1", NULL, ImGuiWindowFlags_MenuBar))
        {
            ...
            static int item = 1;
            static float _color[4] = { 0.4f, 0.7f, 0.0f, 0.5f };
...
struct MyItem
{
    ...
    {
        const MyItem* ObjectCount = (const MyItem*)lhs;
        ...
        for (int n = 0; n < s_current_sort_specs->SpecsCount; n++)
        {
            ...
            {
            case MyItemColumnID_ID:             delta = (ObjectCount->ID - b->ID);                break;
            case MyItemColumnID_Name:           delta = (strcmp(ObjectCount->Name, b->Name));     break;
            case MyItemColumnID_Quantity:       delta = (ObjectCount->Quantity - b->Quantity);    break;
            case MyItemColumnID_Description:    delta = (strcmp(ObjectCount->Name, b->Name));     break;
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::BeginChild("ScrollingRegion", ImVec2(0, -footer_height_to_reserve), ImGuiChildFlags_None, ImGuiWindowFlags_HorizontalScrollbar))
        {
            ...
            for (const char* item : Items)
            {
                ...
                if (strstr(item, "[error]")) { _color = ImVec4(1.0f, 0.4f, 0.4f, 1.0f); has_color = true; }
                else if (strncmp(item, "# ", 2) == 0) { _color = ImVec4(1.0f, 0.8f, 0.6f, 1.0f); has_color = true; }
                if (has_color)
...
struct MyDocument
{
    ...
    MyDocument(const char* name, bool open = true, const ImVec4& _color = ImVec4(1.0f, 1.0f, 1.0f, 1.0f))
    {
        Name = name;
        Open = OpenPrev = open;
        Dirty = false;
